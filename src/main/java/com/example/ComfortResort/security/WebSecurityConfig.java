package com.example.ComfortResort.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.POST, "/api/users/login", "/api/users/signup", "/api/search/groups/simple", "/api/search/groups/advanced").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/users/all").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/users/password-change").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/groups/**", "/api/posts/").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/groups/", "/api/posts/").permitAll()
